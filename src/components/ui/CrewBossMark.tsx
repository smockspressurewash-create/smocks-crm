  ...
  return (
    <svg viewBox="0 0 64 64" className={className} fill="none">
      <g stroke="#ffffff" strokeWidth={6.5} strokeLinecap="round">
        <path d="M25 34 L11 44" fill="none" />
        <path d="M39 34 L53 44" fill="none" />
      </g>
      <circle cx="9" cy="45" r="4.2" fill="#ffffff" />
      <circle cx="55" cy="45" r="4.2" fill="#ffffff" />
      ...
      <text x="8" y="42" fontFamily="Arial, Helvetica, sans-serif" fontWeight={900} fontSize={32} fill="#ffffff" textAnchor="middle">C</text>
      <text x="56" y="42" fontFamily="Arial, Helvetica, sans-serif" fontWeight={900} fontSize={32} fill="#ffffff" textAnchor="middle">B</text>
    </svg>
  );
}
