  ...
  return (
    <svg viewBox="0 0 64 64" className={className} fill="none">
      <g stroke="#ffffff" strokeWidth={6.5} strokeLinecap="round">
        <path d="M25 34 L13 44" fill="none" />
        <path d="M39 34 L51 44" fill="none" />
      </g>
      <circle cx="12" cy="45" r="4.2" fill="#ffffff" />
      <circle cx="52" cy="45" r="4.2" fill="#ffffff" />
      ...
      <text x="10" y="41" fontFamily="Arial, Helvetica, sans-serif" fontWeight={900} fontSize={29} fill="#ffffff" textAnchor="middle">C</text>
      <text x="54" y="41" fontFamily="Arial, Helvetica, sans-serif" fontWeight={900} fontSize={29} fill="#ffffff" textAnchor="middle">B</text>
    </svg>
  );
}
